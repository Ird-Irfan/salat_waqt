    ...
    return PresentableWidgetBuilder(
      ...
      builder: () {
        return InkWell(
          ...
          onTap: () {
            presenter.toggleExpansionLang();
          },
          child: Container(
            width: double.infinity,
            height: presenter.currentUiState.isExpandedLang ? 220.px : 90.px,
                  ...
                  Row(
                    children: [
                      ...
                      Padding(
                        ...
                        child: presenter.currentUiState.isExpandedLang
                            ? SvgIcon(svgPath: AppConstant.icArrowUp)
                            : SvgIcon(svgPath: AppConstant.icArrowDown),
                      ),
                    ],
                  ),
                  if (presenter.currentUiState.isExpandedLang)
                    Expanded(
                      child: Column(
                        children: [
                          _buildSelectableText(
                            selectedTextOne ?? "Text One",
                            presenter.currentUiState.selectedText,
                          ),
                          _buildSelectableText(
